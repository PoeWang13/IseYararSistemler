...
public class Gemiler : MonoBehaviour
{
    ...
    public void GemiEkle()
    {
        ...
        seciliGemi.gemiBuyukluk = int.Parse(gemiBuyukluk.text);
        seciliGemi.gemiGold = int.Parse(gemiGold.text);
        seciliGemi.gemiOdun = int.Parse(gemiOdun.text);
        seciliGemi.gemiKaynak = int.Parse(gemiKaynak.text);
        seciliGemi.gemiKaynakType = (KaynakType)gemiKaynakType.value;
        seciliGemi.gemiDepo[0] = int.Parse(gemiLimit.text);
        seciliGemi.gemiDepo[1] = int.Parse(gemiLimitNext.text);
